...
Setup:
    ...
    MOVLW 0X00
    MOVWF TRISA
    MOVLW 0XF0 ;Put bits into register
    ...
    DisplayC EQU 0x24 ;Saves Display Data for PORTC
...
MainWrite:
    ...
    MOVLW 0x55 ;Choose Where to Writed
    MOVWF EEADR
    MOVF DisplayC,0 ;Choose what to write
    MOVWF EEDAT
...
;------------------------------------------------------------------------------
    ...
    BCF STATUS,5 ;Bank 0
    BCF STATUS,6
    MOVLW 0x55 ; Any location in Data EEPROM memory space
